...
#include "../QtSocketsAccelerometer/serverthread.h"
...
QT_MOC_LITERAL(1, 13, 14), // "sampleReceived"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 12), // "SensorSample"
QT_MOC_LITERAL(4, 42, 6) // "sample"

    },
    "ServerThread\0sampleReceived\0\0SensorSample\0"
    "sample"
};
...
void ServerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sampleReceived((*reinterpret_cast< const SensorSample(*)>(_a[1]))); break;
        default: ;
        }
        ...
        case 0:
            ...
            default: *reinterpret_cast<int*>(_a[0]) = -1; break;
            case 0:
                *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< SensorSample >(); break;
            }
            break;
        }
        ...
        {
            typedef void (ServerThread::*_t)(const SensorSample & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ServerThread::sampleReceived)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ServerThread::sampleReceived(const SensorSample & _t1)
{
